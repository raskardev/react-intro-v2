            ...
            <div className="w-1/3 border flex flex-col">
              ...
              <div className="bg-grey-lighter flex-1 overflow-auto">
                <div className="px-3 flex items-center bg-grey-light cursor-pointer">
                  ...
                  <div className="ml-4 flex-1 border-b border-grey-lighter py-4">
                    <div className="flex items-bottom justify-between">
                      <p className="text-grey-darkest">Los mercenarios ¿4?</p>
                ...
                <div className="bg-white px-3 flex items-center hover:bg-grey-lighter cursor-pointer">
                  ...
                  <div className="ml-4 flex-1 border-b border-grey-lighter py-4">
                    <div className="flex items-bottom justify-between">
                      <p className="text-grey-darkest">El Chuache</p>
                      <p className="text-xs text-grey-darkest">12:45 pm</p>
                    </div>
                ...
                <div className="py-2 px-3">
                  ...
                  <div className="flex mb-2">
                    <div
                      ...
                      style={{ backgroundColor: '#F2F2F2' }}
                    >
                      <p className="text-sm text-purple-600">Tom Cruise</p>
                      <p className="text-sm mt-1">
                  ...
                  <div className="flex mb-2">
                    <div
                      ...
                      style={{ backgroundColor: '#F2F2F2' }}
                    >
                      <p className="text-sm text-orange-900">Harrison Ford</p>
                  ...
                  <div className="flex mb-2">
                    <div
                      ...
                      style={{ backgroundColor: '#F2F2F2' }}
                    >
                      <p className="text-sm text-orange-500">Russell Crowe</p>
                      <p className="text-sm mt-1">
